...
// the one runtime file that carries them is lib/legacy-redirects.server.mjs,
// whose whole purpose is to send the retired vocational and life-care-planning
// routes to those practices.
