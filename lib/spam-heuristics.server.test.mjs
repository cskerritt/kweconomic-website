...
const LEGIT = [
  ...
  { name: "Nguyen Thi Minh", email: "nguyen.tm@example.com", message: "Requesting a lost earnings analysis for a client." },
  { name: "Sharon McDonald-DiMaggio", email: "sharon@example.org", message: "Please call about a wrongful death claim for a client." },
...
const BORDERLINE = [
  ...
  { name: "Krystof Pfingstl", email: "kp@example.com", message: "Economic damages expert needed for a hearing." },
];
