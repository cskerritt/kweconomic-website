    ...
    <section className="relative isolate overflow-hidden rounded-xl bg-gradient-to-br from-navy via-navy to-navy-dark text-white p-8">
      ...
      <div className="relative z-10">
        ...
        <p className="text-neutral-300 mb-6 max-w-2xl">
          KWVRS provides independent, objective analysis for plaintiff and defense
          counsel nationwide. Tell us about the matter and we will scope the
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Link
            ref={magnet}
            to="/contact"
            className="kw-magnetic group inline-flex items-center justify-center gap-2 bg-amber-dark hover:bg-amber-dark text-white font-semibold px-6 py-3 rounded-lg transition-colors shadow-lg shadow-amber/20"
          >
