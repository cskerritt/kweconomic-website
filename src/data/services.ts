...
export const services: Service[] = [
  ...
  },
  {
    ...
    pillar: true,
    description: "Life care plans built for workers' compensation matters, covering future medical care, attendant care, and rehabilitation needs, coordinated with the vocational specialist where return-to-work is contested.",
    icon: "HardHat",
    ...
    cost: {
      ...
      drivers: [
        ...
        "Whether return-to-work is contested and a separate vocational opinion is in scope",
    ...
    process: [
      ...
      { step: "Future care and return-to-work projection", description: "We project future medical, rehabilitation, equipment, and attendant care needs and note where return-to-work is contested so the plan can be reconciled with any separate vocational opinion." },
