...
Forensic economists typically value household services using [[/tools/household-services|replacement cost methodology]]: what would it cost to hire qualified workers to perform the tasks the plaintiff can no longer perform? This requires data on two things: (1) the time the individual spent on each category of household service before the injury, and (2) the wage rate for workers who perform those services in the relevant labor market. The primary empirical source for time-use data is the Bureau of Labor Statistics' [[/tools/household-services/methodology|American Time Use Survey (ATUS)]], which publishes detailed data on the time American households spend on various activities, broken down by demographic variables including gender, age, employment status, and presence and age of children (U.S. Bureau of Labor Statistics, n.d.).
