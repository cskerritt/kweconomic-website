...
export const stateRegulations: StateRegulation[] = [
  ...
  },
  {
    ...
    damagesContext: "Iowa's wrongful death recovery belongs to the estate and is measured by the present value of what the decedent would have accumulated over a normal lifetime net of personal expenses, with the spouse's and children's loss of consortium recovered separately, which makes the economist's net-accumulation projection central. Recovery is barred once the plaintiff's fault exceeds the combined fault of the defendants, the court receives evidence of collateral-source payments after verdict to prevent double recovery except where a subrogation right exists, and interest on a judgment runs from the filing of the petition on past losses but only from judgment on future damages.",
  },
  {
    stateSlug: "kansas",
